...
- **Release**: Once an item is successfully submitted, published, or rejected by a verifier, the lease is explicitly released by the Orchestrator upon processing the `ActionResponse`.