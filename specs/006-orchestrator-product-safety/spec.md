...
- **FR-003**: **Policy Enforcement**: Update `skill/SKILL.md` to define the authoritative relationship between machine summary reason codes and agent branching logic.
