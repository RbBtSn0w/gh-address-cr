import unittest
from src.gh_address_cr.core.reply_templates import fix_reply, _normalize_severity
...
class TestReplyTemplates(unittest.TestCase):
    ...
    def test_fix_reply_p1_rationale_length_validation(self):
        # US1: P1 requires rich rationale
        with self.assertRaises(SystemExit) as cm:
            fix_reply("P1", ["sha123", "src/file.py", "pytest", "Passed", "Too short."])
        self.assertIn("requires a rich technical rationale", str(cm.exception))
