...
def session_file(repo: str, pr_number: str) -> Path:
    return session_store.session_file(repo, pr_number)


def audit_log_file(repo: str, pr_number: str) -> Path:
    return session_store.workspace_dir(repo, pr_number) / core_paths.audit_log_file(repo, pr_number).name


def audit_summary_file(repo: str, pr_number: str) -> Path:
    return session_store.workspace_dir(repo, pr_number) / core_paths.audit_summary_file(repo, pr_number).name
...
def write_audit_event(
    ...
    path = audit_log_file(repo, pr_number)
